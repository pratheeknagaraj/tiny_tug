...
function Game_Presets(){
    ...
    this.get_game_preset = function(number){
        ...
        if (number == 1){
            ...
            var player3 = {'name': 'pratnag', 'ai': false};
            var player4 = {'name': 'viber', 'ai': false};
        ...
        if (number == 2){
            var player1 = {'name': 'sergei', 'ai': false};
            var player2 = {'name': 'arch', 'ai': false};
            var player3 = {'name': 'koko', 'ai': false};
            ...
            var teams = {'Pratheek': team1, 'Corey': team2, 'Kaustav': team3};
