...
function Game_Presets(){
    ...
    this.get_game_preset = function(number){
        ...
        if (number == 1){
            var player1 = {'name': 'PopeyesChickenSucker', 'ai': false};
            var player2 = {'name': 'pratnag', 'ai': false};
            var player3 = {'name': 'a_jared', 'ai': false};
            var player4 = {'name': 'n_mcripys', 'ai': false};
            ...
            var teams = {'Chewy Bars': team1, 'Black Panthers': team2};
        ...
        if (number == 2){
            var player1 = {'name': 'PopeyesChickenSucker', 'ai': false};
            var player2 = {'name': 'BitchMagnet', 'ai': false};
            var player3 = {'name': 'FuckBoy', 'ai': false};
            var player4 = {'name': 'PizzaGreaseSucker', 'ai': false};
            var player5 = {'name': 'CurryMunchingFaggler', 'ai': false};
            ...
            var teams = {'PopeyesChickenSucker': team1, 'BitchMagnet': team2, 'FuckBoy': team3, 'PizzaGreaseSucker': team4, 'CurryMunchingFaggler': team5};
